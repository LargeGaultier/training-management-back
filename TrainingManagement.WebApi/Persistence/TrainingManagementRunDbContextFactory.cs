...
{
    public class TrainingManagementRunDbContextFactory : IDesignTimeDbContextFactory<TrainingManagementRunDbContext>
    {
        public TrainingManagementRunDbContext CreateDbContext(string[] args)
        {
            ...
            return new TrainingManagementRunDbContext(optionsBuilder.Options);
        }
    }
}
